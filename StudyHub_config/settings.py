...
ROOT_URLCONF = 'StudyHub_config.urls'
TEMPLATES = [
    {
...
WSGI_APPLICATION = 'StudyHub_config.wsgi.application'
DATABASES = {
    'default': {
...
# Email settings for development - OTP will be printed to console
...
DEFAULT_FROM_EMAIL = 'noreply@edustream.com' 
EMAIL_TIMEOUT = 5
